...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_posts(self):
        u1 = User(username="john", email="john@exampl.com")
        u2 = User(username="susan", email="susan@exampl.com")
        u3 = User(username="mary", email="mary@exampl.com")
        u4 = User(username="david", email="david@exampl.com")
